                  ...
                  <div className="col-lg-6 wow fadeInRight">
                    <div className="title-three mb-35 md-mb-20 details-meta">
                      ...
                      <h3 style={{ color: "white" }}>
                        Foot Scan with Podiascan: Precision Diagnostics for
                        Optimal Foot Health
                      </h3>
                    </div>
                    <p
                      ...
                      style={{ color: "#fff9" }}
                    >
                      Podiascan is an advanced foot scanning solution designed
                      to provide accurate insights into foot structure, gait,
                      and pressure distribution. Ideal for diagnosing
                      foot-related issues and enhancing personalized treatment
                      plans, Podiascan empowers healthcare professionals to
                      address a wide range of conditions with precision.
                    </p>
                  </div>
