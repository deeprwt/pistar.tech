...
const NewsletterBannerTwo = () => {
  return (
    <div className="newsletter-banner white-vr" style={{background: "linear-gradient(#313638,#313638)"}}>
      <div className="container">
        <div className="main-wrapper bottom-border">
          <div className="row footer-one" style={{padding: "0px",background: "linear-gradient(#313638,#313638)"}}>
